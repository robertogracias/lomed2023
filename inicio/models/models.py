    ...
    def crear_partida(self):
        ...
        for r in self:
            ...
            if r.analytic_account_id:
                dic={}
                dic[str(r.analytic_account_id.id)]=100
                linea['analytic_distribution']=dic
...
class saldo_inicial_cxc(models.Model):
    ...
    def crear_cxc(self):        
        for r in self:
            ...
            partida['invoice_date_due']=r.x_vencimiento
            lines=[]
            linea={}
            ...
            linea['date_maturity']=r.x_vencimiento
            linea['expected_pay_date']=r.x_vencimiento
            linea['quantity']=1
            linea['display_type']='product'
            linea['debit']=0
            ...
            linea['display_type']='payment_term'
            linea['debit']=r.saldo
            linea['date_maturity']=r.x_vencimiento
            linea['expected_pay_date']=r.x_vencimiento
            linea['credit']=0
